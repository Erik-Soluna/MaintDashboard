...
urlpatterns = [
    ...
    path('map/equipment/add/', views.add_map_equipment, name='add_map_equipment'),
    path('map/equipment/move/', views.move_map_equipment, name='move_map_equipment'),
    path('map/location/remove/', views.remove_map_location, name='remove_map_location'),
    ...
    path('api/agents/', views.agents_api, name='agents_api'),
    path('api/agents/<int:user_id>/', views.agent_detail_api, name='agent_detail_api'),
