    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['name'],
                'constraints': [models.CheckConstraint(check=models.Q(('is_site', True), models.Q(('parent_location', None), _negated=True), _negated=True), name='site_locations_no_parent')],
            },
        ),
    ]
