    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_to', models.ForeignKey(blank=True, help_text='User assigned to perform this maintenance', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assigned_maintenance', to=settings.AUTH_USER_MODEL)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created', to=settings.AUTH_USER_MODEL)),
                ('equipment', models.ForeignKey(help_text='Equipment this maintenance is for', on_delete=django.db.models.deletion.CASCADE, related_name='maintenance_activities', to='equipment.equipment')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated', to=settings.AUTH_USER_MODEL)),
                ('activity_type', models.ForeignKey(help_text='Type of maintenance activity', on_delete=django.db.models.deletion.PROTECT, related_name='activities', to='maintenance.maintenanceactivitytype')),
            ],
            options={
