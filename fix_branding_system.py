        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute('''
                CREATE TABLE core_brandingsettings (
                    ...
                    header_background_color VARCHAR(7) DEFAULT '#0f1419',
                    header_text_color VARCHAR(7) DEFAULT '#ffffff',
                    header_border_color VARCHAR(7) DEFAULT '#4a5568',
                    navigation_background_color VARCHAR(7) DEFAULT '#2d3748',
                    navigation_text_color VARCHAR(7) DEFAULT '#e2e8f0',
                    navigation_hover_color VARCHAR(7) DEFAULT '#4299e1',
                    content_background_color VARCHAR(7) DEFAULT '#1a2238',
                    content_text_color VARCHAR(7) DEFAULT '#e2e8f0',
                    card_background_color VARCHAR(7) DEFAULT '#2d3748',
                    card_border_color VARCHAR(7) DEFAULT '#4a5568',
                    button_primary_color VARCHAR(7) DEFAULT '#4299e1',
                    button_primary_text_color VARCHAR(7) DEFAULT '#ffffff',
                    button_secondary_color VARCHAR(7) DEFAULT '#718096',
                    button_secondary_text_color VARCHAR(7) DEFAULT '#ffffff',
                    form_background_color VARCHAR(7) DEFAULT '#2d3748',
                    form_border_color VARCHAR(7) DEFAULT '#4a5568',
                    form_text_color VARCHAR(7) DEFAULT '#e2e8f0',
                    success_color VARCHAR(7) DEFAULT '#48bb78',
                    warning_color VARCHAR(7) DEFAULT '#ed8936',
                    danger_color VARCHAR(7) DEFAULT '#f56565',
                    info_color VARCHAR(7) DEFAULT '#4299e1',
                    dropdown_background_color VARCHAR(7) DEFAULT '#2d3748',
                    dropdown_background_opacity DECIMAL(3,2) DEFAULT 0.95,
                    dropdown_text_color VARCHAR(7) DEFAULT '#e2e8f0',
                    dropdown_border_color VARCHAR(7) DEFAULT '#4a5568',
                    dropdown_hover_background_color VARCHAR(7) DEFAULT '#4a5568',
                    dropdown_hover_text_color VARCHAR(7) DEFAULT '#ffffff',
                    logo_id INTEGER,
                    favicon VARCHAR(100),
